...
import com.demo.credit.CreditController;
import com.demo.index.IndexController;
import com.demo.join.JoinController;
import com.demo.login.LoginController;
import com.demo.message.MessageController;
import com.demo.project.ProjectController;
import com.demo.task.TaskController;
...
public class DemoConfig extends JFinalConfig {
	...
	public void configRoute(Routes me) {
		...
		me.add("/credit",CreditController.class);
		me.add("/join",JoinController.class);
		me.add("/login", LoginController.class);
		me.add("/task", TaskController.class);			// 第三个参数省略时默认与第一个参数值相同，在此即为 "/blog"
	}
